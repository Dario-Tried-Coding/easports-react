...
export function Banner({ stacked = false, textClrLight = true, logoImg = "", logoMaxWidth = "none", title = "", subtitle = "", body = "", margInlineXL = "var(--marg-inline-section)", bgImageData, textPosition = "center", textAlign = "center", btnContent = "default", btnTransparent = true, btnColor = "var(--clr-dark-700)", btnBgColor = "transparent" }) {
