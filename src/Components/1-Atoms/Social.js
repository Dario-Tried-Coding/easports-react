            ...
            <div className={style.blocco_loghi}>
                ...
                <a className="instalogo" href="https://www.instagram.com/ea/"
                  ><svg
                    ...
                    focusable="false"
                    style={{pointerEvents: "none", display: "block",width: "22px",height:" 22px"}}
                  >
                    <g>
                      <path
            ...
            <a className="ttchlogo" href="https://www.twitch.tv/ea"
              ...
              >
                <g>
                  <path
                    id="Dialog"
                    d="M11.3,13.5h-3l-1.5,2h-2v-2H1.2V3l1-2.6h13.1v9.1L11.3,13.5z M13.8,9V1.9H3.2v9.6h3v2l2-2h3L13.8,9z"
                  ></path>
                  <rect
                    id="_x7C_"
                    x="9.8"
