...
<DesignTokenDocBlock categoryName="Paddings" showSearch={false} />

## Margins

<DesignTokenDocBlock categoryName="Margins" showSearch={false} />

## Gaps

<DesignTokenDocBlock categoryName="Gaps" showSearch={false} />

## Flow Spacers

<DesignTokenDocBlock categoryName="Flow Spacers" showSearch={false} />